...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: 'https://belan.tech/docs', lastModified: new Date('2026-09-12'), changeFrequency: 'monthly', priority: 0.6 },
    { url: 'https://belan.tech/deck', lastModified: new Date('2026-09-12'), changeFrequency: 'monthly', priority: 0.5 },
    { url: 'https://belan.tech/docs/onboarding-playbook.html', lastModified: new Date('2026-09-12'), changeFrequency: 'monthly', priority: 0.5 },
