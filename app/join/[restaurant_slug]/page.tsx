...
const FALLBACK_DISCLOSURE =
  "By checking this box, I agree to receive recurring automated marketing text messages at the phone number provided. Consent is not a condition of purchase. Msg & data rates may apply. Message frequency varies. Reply STOP to opt out, HELP for help.";
...
export default function JoinPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (!consentChecked) { setError("Please check the box to agree to receive texts."); return; }
  ...
  const headline = pageState === "loading" ? "" : `Get ${pct}% off your next order`;
      ...
      <div className="w-full max-w-sm bg-white rounded-2xl shadow-xl ring-1 ring-black/5 overflow-hidden">
        ...
        {pageState === "invalid" && (
          <div className="px-6 py-10 text-center">
            ...
            <p className="font-semibold text-gray-700 mb-2">Sign-Up Link Not Found</p>
          ...
          <form onSubmit={handleSubmit} className="px-6 py-6 space-y-4">
            ...
            <label className="flex items-start gap-2 text-[11px] text-gray-500 leading-relaxed">
              <input
                ...
                disabled={pageState === "submitting"}
              />
              <span>{data?.consent_disclosure_text || FALLBACK_DISCLOSURE}</span>
            </label>
