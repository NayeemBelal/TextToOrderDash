...
const PRODUCTS = [
  ...
  },
  {
    color: "#a1dfc5",
    name: "Dashboard",
    tagline: "See & configure everything",
        ...
        {PRODUCTS.map(({ color, name, tagline, desc, bullets, img }) => (
          ...
          >
            <div className="flex-1 p-5">
              ...
              <div className="text-xs font-bold text-black/50 uppercase tracking-widest mt-0.5 mb-2">
                {tagline}
              </div>
              ...
              <ul className="flex flex-col gap-1.5">
                {bullets.map((b) => (
                  <li
                    key={b}
                    className="flex items-start gap-2 text-xs font-bold text-black"
                  >
          ...
          <div className="flex flex-col gap-4">
            ...
            <ul className="flex flex-col gap-2 mt-1">
              {voice.bullets.map((b) => (
                <li
                  key={b}
                  className="flex items-start gap-2 text-sm xl:text-base font-bold text-black leading-snug"
                >
...
function buildConversation(greeting: string, items: MenuItem[]) {
  ...
  return [
    ...
    {
      role: "ai" as const,
      text: `Perfect! ${firstItem.name} ($${firstItem.price}) added. Anything else?`,
    },
...
const SALES_RESPONSES: { match: RegExp; reply: string }[] = [
  ...
  },
  {
    ...
    reply:
      "Your top 3 last Thursday: Classic Smashburger (47), Double Stack (34), Crispy Chicken (28).",
  },
  {
    match: /slow|quiet|dead|worst/i,
    reply:
      "Your slowest window is 2–4pm on weekdays — averaging only 4 orders/hour. A happy hour promo could help.",
  },
  {
  ...
  },
  {
    ...
    reply:
      "Last week's total: $11,240 across 892 orders. That's up 8% from the previous week.",
  },
];
...
function getSalesReply(input: string): string {
  ...
  return (
    match?.reply ??
    "Based on your data: orders are trending up 9% week-over-week, with burgers driving 74% of revenue. Want me to dig into a specific item?"
  );
}
...
function SandboxSection() {
  ...
  return (
    <RevealSection
      id="sandbox"
      className="py-16 md:py-20 xl:py-32 px-4 sm:px-8 md:px-16 xl:px-24 2xl:px-32"
      style={{ position: "relative", zIndex: 1 }}
    >
      <div className="max-w-6xl xl:max-w-7xl 2xl:max-w-[1400px] mx-auto">
        <motion.div
          variants={fadeUp}
          className="mb-8 md:mb-10 xl:mb-14 flex items-start gap-4"
        >
          <div className="flex-1">
            <div
              className="inline-block border-2 border-black px-3 py-1.5 mb-3 text-xs md:text-sm xl:text-base font-bold"
              style={{
                background: "#e01d5a",
                color: "white",
          ...
          {dropdownOpen &&
            ...
            createPortal(
              <div
                ref={dropdownRef}
                style={dropdownStyle}
                className="border-2 border-t-0 border-black bg-white shadow-[4px_4px_0px_#000] overflow-hidden"
              >
                {(["demo", "sales", "marketing"] as const).map((tab) => {
                  ...
                  return (
                    ...
                    >
                      <span
                        className={`w-2.5 h-2.5 rounded-full border-2 flex-shrink-0 ${isSelected ? "bg-white border-white" : "border-black"}`}
                      />
        ...
        <motion.div
          variants={fadeIn}
          className="hidden md:inline-flex gap-0 mb-8 xl:mb-10 border-2 border-black"
        >
          {(["demo", "sales", "marketing"] as const).map((tab) => (
            <button
              key={tab}
                  ...
                  <div className="p-5 border-b-2 border-black flex flex-col items-center text-center gap-4">
                    <div>
                      ...
                      <p className="text-xs font-bold text-black/50 mt-3">
                        Same AI handles calls and texts — one number.
                      </p>
                    </div>
                  ...
                  <div className="p-5 flex flex-col gap-4">
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-2 gap-1">
                        {[
                          ...
                          { name: "Crispy Chicken", price: "11.49" },
                          { name: "Loaded Fries", price: "5.99" },
                        ].map((item) => (
                          <div
                            key={item.name}
                            className="flex items-center justify-between px-2 py-1.5 border border-black text-xs"
                    ...
                    <div>
                      ...
                      <div className="flex flex-col gap-1">
                        {[
                          '"I\'d like a Double Stack and Fries"',
                          '"What comes on the Crispy Chicken?"',
                        ].map((q) => (
                          <div
                            key={q}
                            className="text-xs font-bold text-black/60 px-3 py-1.5 border border-black/20"
                    ...
                    <div className="flex flex-col items-center text-center gap-6 py-4">
                      <div>
                        ...
                        <p className="text-sm xl:text-base font-bold text-black/50 mt-4 max-w-sm xl:max-w-md">
                          Call to place a voice order or send a text — the same
                          AI handles both on the same number.
                        </p>
                      </div>
                      <div className="flex items-center gap-2">
                        <div className="w-2 h-2 rounded-full bg-green-500 animate-pulse" />
            ...
            >
              ...
              <div className="md:hidden flex flex-col">
                <div className="border-b-2 border-black">
                  ...
                  <div
                    ref={chatScrollRef}
                    className="h-56 overflow-y-auto p-4 flex flex-col gap-3"
                  >
                    {chatHistory.map((msg, i) => (
                      ...
                      >
                        <div
                          className="max-w-[85%] px-3 py-2 text-xs font-bold border-2 border-black"
                          style={{
                        ...
                        >
                          {msg.role === "ai" && (
                            <span className="text-[10px] font-black block mb-1 opacity-60">
                              SALES AI
                            </span>
                          )}
                          {msg.text}
                ...
                <div className="p-4">
                  ...
                  <div className="flex flex-col gap-1.5">
                    {[
                      "How many Classic Smashburgers did I sell?",
                      "What was my revenue last week?",
                      "When is my slowest time?",
                    ].map((q) => (
                      <button
                        key={q}
            ...
            >
              ...
              <div className="md:hidden flex flex-col">
                ...
                <div className="p-4 flex flex-col gap-2 border-b-2 border-black">
                  {PROMOS.slice(0, 3).map((p) => (
                    <button
                      ...
                      style={{
                        borderColor:
                          selectedPromo === p.id ? "#000" : "rgba(0,0,0,0.15)",
                        background:
                          selectedPromo === p.id
                            ? "#c4b5fd"
                ...
                <div className="p-4 flex flex-col gap-4">
                  ...
                  <div
                    className="p-3 border-2 border-black text-xs font-bold text-black leading-relaxed"
                    style={{ background: "rgba(255,255,255,0.9)" }}
                  >
                    {smsPreview}
                  </div>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.div
          className="max-w-6xl xl:max-w-7xl 2xl:max-w-[1400px] mx-auto w-full flex flex-col items-center text-center py-10"
        ...
        >
          ...
          >
            {[
              ...
              <div
                key={pos}
                className={`absolute w-2.5 h-2.5 sm:w-3 sm:h-3 z-10 ${pos}`}
                style={{
          ...
          >
            ...
            <span className="text-[10px] sm:text-xs xl:text-sm font-bold uppercase tracking-widest text-black">
      ...
      >
        <div
          className="max-w-6xl xl:max-w-7xl 2xl:max-w-[1400px] mx-auto relative"
          style={{ zIndex: 1 }}
        >
          <div className="grid md:grid-cols-[3fr_1fr] gap-8 md:gap-12 xl:gap-20 items-center">
            ...
            <div>
              ...
              <motion.div
                variants={stagger}
                className="flex flex-col gap-3 sm:gap-4 xl:gap-6"
              >
                {[
                  {
                    num: "01",
              ...
              <motion.div
                variants={fadeIn}
                className="mt-6 sm:mt-8 xl:mt-10 flex flex-wrap items-center gap-2"
              >
                ...
                {[
                  ...
                  <div
                    key={label}
                    className="px-2.5 sm:px-3 py-1 sm:py-1.5 border-2 border-black text-xs xl:text-sm font-bold"
                    style={{ background: color }}
                  >
                    {label}
                  </div>
                ...
                <div
                  className="px-2.5 sm:px-3 py-1 sm:py-1.5 border-2 border-black text-xs xl:text-sm font-bold text-white"
      ...
      {/* ── PRODUCTS ── */}
      <RevealSection
        className="py-16 md:py-28 xl:py-36 2xl:py-44 px-4 sm:px-8 md:px-16 xl:px-24 2xl:px-32 relative"
        style={{ zIndex: 1 }}
      >
        <div
          className="max-w-6xl xl:max-w-7xl 2xl:max-w-[1400px] mx-auto relative"
      ...
      {/* ── TESTIMONIALS ── */}
      <RevealSection
        className="py-16 md:py-20 xl:py-32 px-4 sm:px-8 md:px-16 xl:px-24 2xl:px-32 relative overflow-hidden"
        style={{ zIndex: 1 }}
      >
        <div
          className="max-w-5xl xl:max-w-6xl 2xl:max-w-7xl mx-auto relative"
          style={{ zIndex: 1 }}
        >
          <motion.div
            variants={fadeIn}
          ...
          <div className="flex items-end gap-4 mb-8 sm:mb-12 xl:mb-16">
            <motion.h2
              variants={fadeUp}
              className="text-3xl sm:text-4xl xl:text-5xl 2xl:text-6xl font-black text-black flex-1"
            >
          ...
          >
            {[
              ...
              },
              {
                name: "Epic Pizza",
                quote:
                  "The global taste profile is a game changer. When someone visiting from out of town calls, Belan already knows their preferences from other restaurants in the network — every visitor feels like a local regular.",
                color: "#f5dda1",
              },
              {
                name: "Shaghf",
              ...
              >
                <div
                  className="text-4xl sm:text-5xl xl:text-6xl font-black mb-3 leading-none"
                ...
                <div className="text-xs xl:text-sm text-black/50 font-medium">
                  — Owner
                </div>
              </motion.div>
            ))}
      ...
      >
        <div className="max-w-4xl xl:max-w-5xl 2xl:max-w-6xl mx-auto">
          ...
          <motion.h2
            variants={fadeUp}
            className="text-3xl sm:text-4xl xl:text-5xl 2xl:text-6xl font-black text-black mb-2"
          >
            One price. Every AI. Unlimited.
          </motion.h2>
          <motion.p
            variants={fadeIn}
            className="text-black/60 mb-8 sm:mb-10 xl:mb-14 font-medium text-sm sm:text-base xl:text-lg"
          >
          ...
          <div className="relative flex justify-center">
            ...
            >
              <div className="mb-5 sm:mb-6 flex items-center flex-wrap gap-2">
                <span
                  className="text-5xl sm:text-6xl xl:text-7xl 2xl:text-8xl font-black text-black"
                  style={{ fontFamily: "Tektur, sans-serif" }}
                >
                  $200
                </span>
                <span className="text-black/60 font-bold xl:text-lg">
                  {" "}
                  / mo
                </span>
                <motion.span
                  className="text-xs xl:text-sm font-bold border-2 border-black px-2 py-1 inline-block"
                  style={{ background: "#f5dda1" }}
              ...
              <motion.div
                ...
                className="flex flex-col gap-2 xl:gap-3 mb-6 sm:mb-8"
              >
                {[
                  ...
                  <motion.div
                    key={item}
                    variants={fadeIn}
                    className="flex items-start gap-2 text-xs sm:text-sm xl:text-base font-medium text-black"
                  >
                    <span
      ...
      {/* ── CTA Band ── */}
      <RevealSection
        className="py-16 md:py-20 xl:py-32 px-4 sm:px-8 md:px-16 xl:px-24 text-center"
      ...
      >
        ...
        <motion.p
          variants={fadeUp}
          className="text-black/70 text-sm sm:text-base md:text-lg xl:text-xl 2xl:text-2xl font-medium mb-6 sm:mb-8 xl:mb-12"
        >
      ...
      {/* ── Footer ── */}
      <footer
        className="py-5 sm:py-6 xl:py-8 px-4 sm:px-8 xl:px-16"
        style={{ position: "relative", zIndex: 1 }}
      >
