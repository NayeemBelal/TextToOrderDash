          ...
          <div className="bg-white dark:bg-black rounded-lg border border-gray-200 dark:border-gray-800 shadow-sm p-6 mb-6 transition-colors">
            <div className="flex items-start justify-between">
              <div className="flex-1">
                ...
                <div className="flex items-center gap-6 mt-3">
                  ...
                  <div className="flex gap-4 text-sm text-gray-600 dark:text-gray-400">
                    <span><span className="font-semibold text-gray-900 dark:text-white">{item.orders.toLocaleString()}</span> orders</span>
                    <span><span className="font-semibold text-gray-900 dark:text-white">{formatCurrency(item.revenue)}</span> revenue (30d)</span>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col items-end gap-2">
                <div className="text-sm font-medium text-gray-600 dark:text-gray-400">Text-to-Order</div>
                <button
                ...
                >
                  <span className={`inline-block h-6 w-6 transform rounded-full bg-white transition-transform ${item.available ? 'translate-x-7' : 'translate-x-1'}`} />
                </button>
              </div>
            </div>
