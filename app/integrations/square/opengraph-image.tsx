...
export const alt = "Square POS Voice AI Integration | Belan AI";
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "20px", maxWidth: "820px" }}>
          ...
          <p style={{ color: "#6B7280", fontSize: "26px", fontFamily: "sans-serif", margin: 0 }}>
            Every call answered · Every order fired to Square
          </p>
        </div>
        ...
        >
          ...
          >
            <span style={{ color: "#BFDBFE", fontSize: "18px", fontFamily: "sans-serif" }}>
              Square POS
            </span>
          </div>
          <div
