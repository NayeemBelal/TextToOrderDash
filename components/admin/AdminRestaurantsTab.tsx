...
/**
 * One block per signed-up restaurant with a quick 30-day revenue glance.
 * Click a block to open that restaurant's dashboard (/admin/[restaurantId]).
 */
  ...
  return (
    <div className="p-4">
      <div className="max-w-6xl mx-auto space-y-4">
        <div>
          <h2 className="text-lg font-bold text-capy-text">Restaurants</h2>
