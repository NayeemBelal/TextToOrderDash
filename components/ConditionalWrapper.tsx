...
const FULL_PAGE_ROUTES = ['/', '/login', '/register', '/about', '/privacy-policy', '/terms-of-service', '/marketing-terms', '/how-it-works', '/integrations', '/forgot-password', '/reset-password', '/prize', '/r', '/join', '/marketing', '/oldprods', '/docs'];
